...
architecture Behavioral of TrafficLightsFSM is
	...
	constant YELLOW_TIME			: std_logic_vector(31 downto 0) := x"08f0d180"; -- 3 s
	constant GREEN1_TIME			: std_logic_vector(31 downto 0) := x"29b92700"; -- 14 s
	constant GREEN2_TIME			: std_logic_vector(31 downto 0) := x"1dcd6500"; -- 10 s
	constant INTERMIT_MIN_TIME	: std_logic_vector(31 downto 0) := x"11e1a300"; -- 6 s

	type TState is (TInit, TIntermit,
						 TRed1, TYellow1, TGreen1, RealYellow,
